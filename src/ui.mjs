...
export function mountUI(host,callbacks) {
  ...
  :host{all:initial;position:fixed;right:14px;bottom:82px;z-index:2147483000;font-family:system-ui,"Microsoft YaHei",sans-serif;color:#e9e7df;font-size:14px;line-height:1.65;color-scheme:dark}
  *{box-sizing:border-box}button,input,select{font:inherit}button{cursor:pointer}button:disabled{opacity:.5;cursor:wait}button,input,select{border:1px solid #605d4e;border-radius:8px;background:#232821;color:#ecebdf;padding:9px 12px}button:hover{background:#394332}button:focus-visible,input:focus-visible,select:focus-visible{outline:2px solid #d1b678;outline-offset:2px}
  .dock{box-shadow:0 6px 20px #0006;background:#26352e;border-color:#b59e66;padding:9px 18px}.dock small{display:block;font-size:10px;color:#c1c5b8;letter-spacing:2px}
  .panel{display:none;position:fixed;right:16px;bottom:145px;width:min(470px,calc(100vw - 24px));height:min(710px,calc(100dvh - 175px));background:#18211c;border:1px solid #69715f;border-radius:16px;box-shadow:0 18px 80px #0009;overflow:hidden;flex-direction:column}.panel.open{display:flex}
  ...
  @media(max-width:520px){:host{right:9px;bottom:76px}.panel{right:8px;bottom:132px;height:calc(100dvh - 150px);width:calc(100vw - 16px)}main{padding:0 14px 16px}header{padding:12px 14px 8px}nav{padding:6px 10px}.dock{padding:7px 13px}}
